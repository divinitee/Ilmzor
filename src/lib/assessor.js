  ...
  try {
    const res = await base44.integrations.Core.InvokeLLM({
      prompt: [
        ...
        `"correct", "wrong_conjunction_type" (used coordinating instead of subordinating,`,
        `or otherwise the wrong kind of connector), "sentence_fragment", "run_on_or_comma_splice",`,
        `"verb_tense_error", "off_topic_or_blank".`,
        ``,
