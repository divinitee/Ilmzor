...
export default [
  ...
  d.mcq({ b: "frequency", t: "rarely", L: "A1", diff: 2, focus: "rarely ≈ once a week", pre: ["frequency-adverbs"],
    prompt: "She ______ goes to the gym — only about once a year.", options: ["always", "never", "sometimes", "rarely"], key: 3, why: "Once a year is very low but non-zero frequency → rarely.",
    legacy: A1("She ______ goes to the gym, about once a week.", "Original 'about once a week' is compatible with both 'sometimes' and 'rarely'. Frequency anchor changed to 'only about once a year', which excludes 'sometimes' while keeping the same target (rarely for very low frequency). Same branch, topic, level and difficulty.") }),
