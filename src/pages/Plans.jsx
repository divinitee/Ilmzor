  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-violet-50 dark:from-slate-950 dark:to-indigo-950">
      <header className="bg-background/80 backdrop-blur border-b border-border px-4 pb-3 flex items-center gap-3 safe-header sticky top-0 z-30">
        ...
        <span className="font-bold text-foreground select-none">Obuna rejalari</span>
      </header>

      <div className="max-w-lg mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Barcha obuna rejalari</h1>
          <p className="text-sm text-muted-foreground mt-2">
            O'zingizga mos rejani tanlang. Premium rejalar 🤖 <strong className="text-foreground">AI So'z Ustozi</strong> imkoniyatini o'z ichiga oladi.
          </p>
        </div>
        ...
        <Link to="/pricing">
          <Button className="w-full h-12 text-base font-bold mt-8 select-none">
            Obunani tanlash va to'lov qilish →
          </Button>
        </Link>
      </div>
    </div>
