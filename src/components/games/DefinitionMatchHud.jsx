...
// Header chrome: back / title / tries left / XP / streak. The tries counter is
// always visible while playing, so running out is never a surprise.
export default function DefinitionMatchHud({ accent, onBack, xp, streak, triesLeft, showTries, lowTries }) {
