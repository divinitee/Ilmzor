...
// Local copy for Context Guess only, following definitionMatchCopy.js's
// convention (src/i18n/translations.js is not touched by game engines).
// The old engine had zero translation coverage — every string was hardcoded
// English inside VocabMcqShell.
const COPY = {
  en: {
    title: "Context Guess",
    instruction_translation: "Read the sentence, then pick the word's meaning.",
    instruction_synonym: "Read the sentence, then pick the closest word.",
    xp: "XP",
    streak: "Streak",
    attempts: "Tries left",
  ...
  uz: {
    title: "Kontekstdan Top",
    instruction_translation: "Gapni o'qing, so'ng so'zning ma'nosini tanlang.",
    instruction_synonym: "Gapni o'qing, so'ng eng yaqin so'zni tanlang.",
    xp: "XP",
    streak: "Ketma-ketlik",
  ...
  ru: {
    title: "Угадай по контексту",
    instruction_translation: "Прочитайте предложение и выберите значение слова.",
    instruction_synonym: "Прочитайте предложение и выберите самое близкое слово.",
    xp: "XP",
    streak: "Серия",
...
export function useContextCopy() {
