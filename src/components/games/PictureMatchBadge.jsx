...
// Provenance badge — why this word is in your round. Same three states as
// Definition Match's, with Picture Match's own copy module.
export default function PictureMatchBadge({ provenance, solved, compact = false }) {
  const { c } = usePictureCopy();
