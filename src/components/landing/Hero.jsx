...
function HeroPreview() {
  return (
    ...
    >
      ...
      <div className="bg-white landing-dark:bg-slate-900 border border-slate-200 landing-dark:border-slate-800 shadow-xl p-6">
        <div className="flex items-center justify-between mb-4">
          <span className="text-xs font-semibold text-teal-600 landing-dark:text-teal-300 bg-teal-50 landing-dark:bg-teal-950/40 px-2.5 py-1 rounded-full">Business English</span>
          <span className="text-xs font-medium text-slate-400 landing-dark:text-slate-500">Intermediate</span>
        </div>

        <div className="flex items-baseline gap-3">
          <h3 className="text-2xl font-bold text-slate-900 landing-dark:text-slate-50">negotiate</h3>
          <span className="text-sm text-slate-400 landing-dark:text-slate-500">/nɪˈɡoʊʃieɪt/</span>
        </div>

        <p className="mt-3 text-sm text-slate-600 landing-dark:text-slate-300">to discuss and reach an agreement</p>
        ...
        <div className="mt-4 p-3.5 rounded-xl bg-slate-50 landing-dark:bg-slate-800/50 border border-slate-100 landing-dark:border-slate-800">
          <p className="text-[11px] uppercase tracking-wide text-slate-400 landing-dark:text-slate-500 mb-1 font-semibold">Example</p>
          <p className="text-sm text-slate-700 landing-dark:text-slate-300">We need to negotiate the contract before Friday.</p>
        </div>
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-xs text-slate-400 landing-dark:text-slate-500">Personalized for your level</span>
          </div>
        </div>
      </div>
      ...
      <motion.div
        ...
        className="absolute -top-4 -right-3 bg-white landing-dark:bg-slate-900 rounded-xl border border-slate-200 landing-dark:border-slate-800 shadow-lg px-3 py-2 flex items-center gap-2"
      >
        <span className="text-base">🎯</span>
        <span className="text-xs font-semibold text-slate-700 landing-dark:text-slate-200">Word of the day</span>
      </motion.div>
    </motion.div>
  );
}
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-5 pt-14 pb-20 lg:pt-20 grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="mt-4 text-xs text-slate-400 landing-dark:text-slate-500">Free to start · No credit card required</p>
        </div>
